...
fun Project.preprocessDocs(file: File, additionalProperties: Map<String, String> = emptyMap()): PreprocessDocsTask {
    ...
    val preprocessTask = tasks.create("preprocess${file.nameWithoutExtension}", PreprocessDocsTask::class.java){
        group = "documentation"
        this.file.set(file)
...
fun Project.preprocessDocs(file: String, vararg additionalProperties: Pair<String, String>): PreprocessDocsTask = preprocessDocs(project.file(file), additionalProperties.toMap())
